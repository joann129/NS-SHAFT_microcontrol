...
{	
	...
	for(i=0; i<3; i++) {
		...
		draw_Bmp32x8(platx[i],platy[i],0xFFFF,0x0000,platSting[platType[i]]);
	}
...
{
  TIMER_Open(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020)), (1UL << 27), 8.16);
...
int main(void)
{
  ...
  u32ADCvalue = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(6)] & (0xFFFFul << 0));
	...
	platType[1] = rand()%4;
	platType[2] = rand()%4;
	draw_Bmp128x8(0,0,0xFFFF,0x0000,bigsting);
	draw_Bmp32x8(platx[0],24,0xFFFF,0x0000,platSting[platType[0]]);
	draw_Bmp32x8(platx[1],40,0xFFFF,0x0000,platSting[platType[1]]);
	draw_Bmp32x8(platx[2],56,0xFFFF,0x0000,platSting[platType[2]]);
  ...
  while(1)
	{
		...
		if(keyin == 1)
		{
			...
			platx[1] = rand()%97;
			platx[2] = rand()%97;
			draw_Bmp32x8(platx[0],24,0xFFFF,0x0000,sting);
			draw_Bmp32x8(platx[1],40,0xFFFF,0x0000,sting);
			draw_Bmp32x8(platx[2],56,0xFFFF,0x0000,sting);
